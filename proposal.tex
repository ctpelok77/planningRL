...
% \item 
%
\item What considerations should lead a practitioner to favor techniques from one community over another?  For
instance, whether the problem to solve is seen only once by the solver, or if the solver would
solve variations of the same problem for weeks or years is one such consideration.
...
\item \href{www.rickvalenzano.com}{Rick Valenzano}
  (\href{mailto:rick.valenzano@elementai.com}{rick.valenzano@elementai.com})\\
  
Rick Valenzano is an Applied Research Scientist at Element AI where he develops sequential decision-making approaches for financial applications. His research focuses on understanding different sequential decision-making methods, such as those used in reinforcement learning, automated planning, heuristic search, and game-playing systems. Rick holds a PhD in Computing Science at the University of Alberta, and was also a postdoctoral fellow in the Department of Computer Science at the University of Toronto. 
